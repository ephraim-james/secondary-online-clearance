...
<aside class="main-sidebar sidebar-dark-primary bg-primary text-light elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link bg-primary">
        <img src="{{ asset('graduate.png') }}" alt="Vemto Logo" class="brand-image bg-white img-circle">
        <span class="brand-text font-weight-bold">Student Clearance</span>
    </a>
                ...
                @auth
                    ...
                    @can('view-any', App\Models\Clear::class)
                        @if (Auth::user()->hasRole('student') && !empty(Auth::user()->student))
                            ...
                            ?>
                            <li class="nav-item">
                                <a href="{{ $student->clearance ? route('student-clearance.show', $student) : '#' }}"
                                    class="nav-link {{ $student->clearance ? '' : 'disabled' }}">
                                    <i class="nav-icon fas fa-file-signature"></i>
                                    <p>Clearance @if ($student->clearance && $student->clearance->completed_clears() == true)
                                            <span class="badge badge-secondary">complete</span>
                                        @elseif($student->clearance && $student->clearance->completed_clears() == false)
