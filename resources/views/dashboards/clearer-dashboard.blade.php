@auth
    <div class="row mb-3">
        <div class="col-sm-12 d-flex justify-content-end text-light">
            Welcome <span class="badge badge-light ml-2"> {{ Auth::user()->name }} </span> <span
    ...
    <div class="row">
        <div class="col-lg-4 col-6">
            <div class="small-box bg-light">
                ...
                <a href="{{ route('clears.index') }}" class="small-box-footer">view<i
        ...
        <div class="col-lg-4 col-6">
            <div class="small-box bg-light">
                ...
                <a href="{{ route('clearances.index') }}" class="small-box-footer">view<i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-4 col-6">
                                    ...
                                    <table id="student_clearances_summary"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending">level</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                            ...
                                            @forelse($clearances as $clear)
                                                <tr class="odd">
                                                    <td class="dtr-control sorting_1" tabindex="0">
                                                        {{ $clear->clearance->name ?? '-' }}</td>
                                                    <td class="dtr-control sorting_1" tabindex="0">
                                                        {{ $clear->clearance->registration_number ?? '-' }}</td>
                                                    <td class="dtr-control sorting_1" tabindex="0">
                                                        {{ $clear->clearance->level ?? '-' }}</td>
