...
<div class="row">
    ...
    <x-inputs.group class="col-sm-12 col-lg-4 mt-4">
        <x-inputs.password name="password" label="Password" maxlength="255"
            placeholder="if you want to change password type new password or leave it empty" :required="!$editing"
            autocomplete="off"></x-inputs.password>
    </x-inputs.group>
